...
<body>
    ...
    <script>
        ...
        function openChat(chatId) {
            const chats = {
                'support': {name: 'Поддержка TrollexDL', avatar: '🛰️', status: 'Онлайн'},
                'community': {name: 'Общий чат', avatar: '👥', status: '12 онлайн'}
            };
        ...
        function openGroup(groupId) {
            const groups = {
                'group1': {name: 'Разработчики', avatar: '👨‍💻', status: '12 участников'},
                'group2': {name: 'Дизайнеры', avatar: '🎨', status: '8 участников'}
            };
